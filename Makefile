...
ACLOCAL = ${SHELL} /root/prg/libode/ode-0.13/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /root/prg/libode/ode-0.13/missing autoconf
AUTOHEADER = ${SHELL} /root/prg/libode/ode-0.13/missing autoheader
AUTOMAKE = ${SHELL} /root/prg/libode/ode-0.13/missing automake-1.14
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/prg/libode/ode-0.13/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /root/catkin_ws/devel/lib/pkgconfig:/opt/ros/melodic/lib/pkgconfig
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
...
X11_CFLAGS = 
X11_LIBS = -lX11
abs_builddir = /root/prg/libode/ode-0.13
abs_srcdir = /root/prg/libode/ode-0.13
abs_top_builddir = /root/prg/libode/ode-0.13
abs_top_srcdir = /root/prg/libode/ode-0.13
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/prg/libode/ode-0.13/install-sh
